...
<img src="./asset/confusion.jpg" height="60px" style="margin-bottom:-3px">
...
It also produces the following outputs
...
* Apologize for these offensive words, but just toward myself. 个人观点，勿对号入座。
